package com.bjmu.order.unionpay.acp.demo;
...
import com.bjmu.order.unionpay.acp.sdk.LogUtil;
import com.bjmu.order.unionpay.acp.sdk.SDKConstants;
/**
 * 重要：联调测试时请仔细阅读注释！
 * 
 * 产品：手机控件产品<br>
 ...
 * 交易说明:1）确定交易成功机制：商户必须开发后台通知接口和交易状态查询接口（Form05_6_5_Query）确定交易是否成功，建议发起查询交易的机制：可查询N次（不超过6次），每次时间间隔2N秒发起,即间隔1，2，4，8，16，32S查询（查询到03，04，05继续查询，否则终止查询）
